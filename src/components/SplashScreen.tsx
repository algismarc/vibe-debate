...
function Bust({
  ...
  return (
    ...
    >
      ...
      {/* Pedestal */}
      <rect x="46" y="178" width="68" height="18" fill={`url(#stone-${variant})`} stroke="#6a2818" strokeWidth="1.5" />
      <rect x="52" y="168" width="56" height="12" fill={`url(#stone-${variant})`} stroke="#6a2818" strokeWidth="1.5" />
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M 56 150 Q 80 162 104 150" stroke="#6a2818" strokeWidth="1.2" fill="none" strokeLinecap="round" />
      ...
      {/* Head */}
      <ellipse cx="80" cy="80" rx="32" ry="40" fill={`url(#stone-${variant})`} stroke="#6a2818" strokeWidth="1.8" />

      {/* Ear (on visible side) */}
      <path d="M 108 78 Q 114 82 112 92 Q 108 94 106 90" fill="none" stroke="#6a2818" strokeWidth="1.3" />
      ...
      {variant === 'bearded' ? (
        <>
          ...
          <path
            ...
            strokeWidth="1.5"
          />
          <path d="M 56 52 Q 62 46 70 48" fill="none" stroke="#6a2818" strokeWidth="1" />
          <path d="M 72 44 Q 80 40 88 44" fill="none" stroke="#6a2818" strokeWidth="1" />
          <path d="M 92 46 Q 100 46 106 52" fill="none" stroke="#6a2818" strokeWidth="1" />
          {/* Beard */}
          <path
            ...
            strokeWidth="1.5"
          />
          <path d="M 66 118 Q 72 128 78 128" fill="none" stroke="#6a2818" strokeWidth="0.9" />
          <path d="M 82 130 Q 88 130 94 120" fill="none" stroke="#6a2818" strokeWidth="0.9" />
          <path d="M 72 122 Q 78 134 82 122" fill="none" stroke="#6a2818" strokeWidth="0.9" />
        </>
      ) : (
        <>
          {/* Helmet / crested cap */}
          ...
          />
          {/* Helmet ridge */}
          <path d="M 60 48 Q 80 36 100 48" fill="none" stroke="#6a2818" strokeWidth="1.4" />
          {/* Small crest notch */}
          <path d="M 78 28 Q 80 22 82 28" fill="none" stroke="#6a2818" strokeWidth="1.2" />
          {/* Short beard */}
          <path
            ...
            strokeWidth="1.4"
          />
          <path d="M 72 112 Q 78 120 80 116" fill="none" stroke="#6a2818" strokeWidth="0.9" />
          <path d="M 82 116 Q 84 120 88 112" fill="none" stroke="#6a2818" strokeWidth="0.9" />
        </>
      )}

      {/* Brow */}
      <path d="M 64 74 Q 72 70 80 72" fill="none" stroke="#6a2818" strokeWidth="1.4" strokeLinecap="round" />
      <path d="M 86 72 Q 94 70 100 74" fill="none" stroke="#6a2818" strokeWidth="1.4" strokeLinecap="round" />
      {/* Eye (single visible, three-quarter view) */}
      <path d="M 68 84 Q 74 80 82 84 Q 74 86 68 84 Z" fill="#6a2818" />
      <path d="M 88 84 Q 94 80 100 84 Q 94 86 88 84 Z" fill="#6a2818" />
      {/* Nose */}
      <path d="M 82 82 Q 82 94 78 102 Q 82 104 86 102" fill="none" stroke="#6a2818" strokeWidth="1.3" strokeLinecap="round" />
      {/* Mouth */}
      <path d="M 74 108 Q 80 110 86 108" fill="none" stroke="#6a2818" strokeWidth="1.2" strokeLinecap="round" />
    </svg>
  )
}
