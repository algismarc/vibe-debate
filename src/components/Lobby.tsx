  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-svh p-4 gap-8">
      ...
      <div className="w-full max-w-sm bg-gray-900 border border-gray-800 rounded-2xl p-6 flex flex-col items-center gap-4">
        ...
        <button
          onClick={copyCode}
          className="font-mono text-4xl sm:text-5xl font-bold tracking-[0.2em] text-purple-400 hover:text-purple-300 transition-colors cursor-pointer"
        ...
        <div className="flex gap-2 w-full">
          <button
            onClick={copyCode}
            className="flex-1 flex items-center justify-center gap-1.5 bg-gray-800 hover:bg-gray-700 border border-gray-700 text-white text-sm font-medium rounded-lg px-3 py-2 transition-colors"
          >
      ...
      {playerSide === 'a' && (
        <button
          ...
          disabled={cancelling}
          className="text-gray-700 hover:text-red-400 text-sm transition-colors disabled:opacity-50"
        >
